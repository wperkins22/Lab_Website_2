...
function loadStatsPage() {
	...
	document.getElementById("wins").innerHTML = totWins;
	document.getElementById("losses").innerHTML = totLoss;
}
...
function switchPlayers(playerNum) {
	...
	document.getElementById("avg_p_yards").innerHTML = avgPass.toFixed();
	document.getElementById("avg_r_yards").innerHTML = avgRush.toFixed();
	document.getElementById("avg_rec_yards").innerHTML = avgRec.toFixed();
}
